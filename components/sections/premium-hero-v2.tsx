      ...
      <div className="relative z-10 mx-auto flex min-h-screen max-w-7xl flex-col justify-center px-6 py-24 lg:grid lg:grid-cols-2 lg:gap-20">
        ...
        >
          ...
          <div className="mt-10 flex flex-col gap-4 sm:flex-row">
            ...
            <Link
              href="/results"
              className="rounded-full border border-white/10 bg-white/5 px-8 py-4 text-center text-white backdrop-blur-xl transition hover:bg-white/10"
            >
              Continue Reading
            </Link>
          </div>
        ...
        >
          ...
          <div className="absolute inset-6 overflow-hidden rounded-[2rem]">
            ...
            <svg viewBox="0 0 400 700" className="absolute inset-0 h-full w-full">
              {[
                ...
                <motion.path
                  ...
                  animate={{ pathLength: [0.2, 1, 0.4], opacity: [0.2, 1, 0.3] }}
